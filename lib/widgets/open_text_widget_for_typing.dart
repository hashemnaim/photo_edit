...
textWidgetForTyping({required bool openTextField,required bool isColors,required TextEditingController name,required Function onRemoved,required bool isEdit,required Color currentColor,required Function onSubmit,required Function onUpdate}) {
    ...
    child: Container(
      ...
      decoration: isColors
          ...
          gradient: LinearGradient(
              colors: isDark?darkColors[selectedElement]: lightColors[selectedElement],
